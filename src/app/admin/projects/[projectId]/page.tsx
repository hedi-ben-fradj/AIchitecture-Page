...
export default function ProjectViewsPage({ params }: { params: { projectId: string } }) {
    ...
    const views = [
        { id: 'birds-eye-view', name: "Bird's Eye View", icon: Eye },
        { id: 'building-view', name: 'Building View', icon: Building2 },
        { id: 'apartment-view', name: 'Apartment View', icon: Home },
    ];
        ...
        <div className="flex flex-col h-full bg-[#313131]">
            ...
            <div className="flex-1 p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {views.map((view) => (
                        <Link key={view.id} href={`/admin/projects/${params.projectId}/views/${view.id}`}>
